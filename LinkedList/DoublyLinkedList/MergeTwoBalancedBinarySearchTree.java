...
// javac -d classes MergeTwoBalancedBinarySearchTree.java  && cd classes && java MergeTwoBalancedBinarySearchTree && cd ..
...
class MergeTwoBalancedBinarySearchTree { 
	// Root of BST 
	Node root;
	// Constructor 
	MergeTwoBalancedBinarySearchTree() { 
		root = null; 
	} 
	...
	public ArrayList<Integer> storeInorderUtil(Node root, ArrayList<Integer> list) { 

		if(root == null) 
			return list; 
		//recur on the left child 
		storeInorderUtil(root.left, list); 
		// Adds data to the list 
		list.add(root.data); 
		//recur on the right child 
		storeInorderUtil(root.right, list); 
	  return list; 
	} 
	
	// Method that stores inorder traversal of a tree 
	ArrayList<Integer> storeInorder(Node tree) { 
		ArrayList<Integer> list1 = new ArrayList<>(); 
		ArrayList<Integer> list2 = storeInorderUtil(tree, list1); 
		return list2; 
	} 
	...
	Node ArrayListToBinarySearchTree(ArrayList<Integer>list, int start, int end) { 
		// Base case 
		...
		root.left = ArrayListToBinarySearchTree(list, start, mid-1); 
		 // Recursively construct the right subtree and make it right child of root 
		root.right = ArrayListToBinarySearchTree(list, mid+1, end); 
	  return root; 
	} 
	...
	Node mergeTrees(Node tree1, Node tree2) { 
		...
		ArrayList<Integer>list1 = storeInorder(tree1); 
		//Stores Inorder of tree2 to list2 
		ArrayList<Integer>list2 = storeInorder(tree2); 		
		...
		Node node = ArrayListToBinarySearchTree(list3, 0, list3.size()-1); 
		return node; 
	} 
	...
	public static void main (String[] args) { 
		...
		MergeTwoBalancedBinarySearchTree tree1 = new MergeTwoBalancedBinarySearchTree(); 
		...
		*/
		...
		MergeTwoBalancedBinarySearchTree tree2 = new MergeTwoBalancedBinarySearchTree(); 
		...
		*/
		...
		System.out.println("The Inorder traversal tree1: "); 
		tree1.inorder(); 
		System.out.println(); 		
		
		System.out.println("The Inorder traversal tree2: "); 
		tree2.inorder(); 
		System.out.println(); 	
		...
		System.out.println("The Inorder traversal of the merged BST(Binary Search Tree) is: "); 
		tree.inorder(); 
		System.out.println(); 
...
/*	
 Output Tree:
 BST(Binary search tree) inorder: 20 40 50 70 80 100 120 300
...
Output Tree:
Marge the above two tree to one BST tree are given,
BST(Binary search tree) inorder: 20 40 50 70 80 100 120 300
