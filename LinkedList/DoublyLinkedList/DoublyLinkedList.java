...
// javac -d classes DoublyLinkedList.java  && cd classes && java DoublyLinkedList && cd ..
...
/*      // Function to reverse a Doubly Linked List 
   ...
   static Node reverse(Node head) {
        ...
        // added all the elements sequemce wise in thestack
        temp = head;
        while (temp != null) {
            temp.data = stack.pop();
            temp = temp.next;
	...
	public static void main(String[] args) { 
        ...
        // deleteNode(dll.head, dll.head.next.next); // delete a node 8
        
        // dll.head = reverse(dll.head); //Reverse a Doubly Linked List
