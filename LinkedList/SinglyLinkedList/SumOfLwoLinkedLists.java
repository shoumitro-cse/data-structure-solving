...
//javac -d classes SumOfLwoLinkedLists.java  && cd classes && java SumOfLwoLinkedLists  && cd ..
public class SumOfLwoLinkedLists 
{ 
	class node 
	{ 
		int val; 
	...
	{ 
		SumOfLwoLinkedLists list = new SumOfLwoLinkedLists(); 
		list.head1 = null; 
		list.head2 = null; 
		list.result = null; 
		list.carry = 0; 
