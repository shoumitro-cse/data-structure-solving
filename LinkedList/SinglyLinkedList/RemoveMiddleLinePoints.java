...
// javac -d classes RemoveMiddleLinePoints.java  && cd classes && java RemoveMiddleLinePoints  && cd ..

class RemoveMiddleLinePoints {
	...
	Node deleteMiddle() {
		...
		// recur for other segment.temporarily store the head and move head forward. 
		Node temp = head; 
		head = head.next; 

		this.deleteMiddle();// call deleteMiddle() for next segment 
	...
	public static void main(String args[]) {
		...
		RemoveMiddleLinePoints llist = new RemoveMiddleLinePoints(); 
