...
//javac -d classes SortedAlternatingAscendingDescending.java  && cd classes && java SortedAlternatingAscendingDescending  && cd ..
class SortedAlternatingAscendingDescending { 
	...
	public static void main(String args[]) {
		...
		SortedAlternatingAscendingDescending llist = new SortedAlternatingAscendingDescending(); 
