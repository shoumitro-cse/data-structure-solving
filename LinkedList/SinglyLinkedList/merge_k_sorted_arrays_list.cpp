...
// g++ merge_k_sorted_arrays_list.cpp && ./a.out
#include <bits/stdc++.h> 
using namespace std; 
...
/*1. Time complexity: O(N2), where N is total number of nodes, i.e., N = kn.
  1. Auxiliary Space: O(1). As no extra space is required.*/
