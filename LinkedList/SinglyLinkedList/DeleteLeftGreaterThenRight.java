...
//javac -d classes DeleteLeftGreaterThenRight.java  && cd classes && java DeleteLeftGreaterThenRight  && cd ..
class DeleteLeftGreaterThenRight {
  ...
  /*Linked List is : 12->15->10->11->5->6->2->3->null */
    public void deleteNodesOnRightSide() {
        Node temp = head;// global
	...
	{
		DeleteLeftGreaterThenRight llist = new DeleteLeftGreaterThenRight();
		...
		llist.deleteNodesOnRightSide(); // good method
