...
//javac -d classes LeftUnbalBSTtoBalBST.java  && cd classes && java LeftUnbalBSTtoBalBST && cd ..
...
{ 
	...
	{ 
         ...
         / 
        5   */
		LeftUnbalBSTtoBalBST tree = new LeftUnbalBSTtoBalBST(); 
