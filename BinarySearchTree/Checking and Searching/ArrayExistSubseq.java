// Java program to find if given array exists as a subsequece in BST 

//javac -d classes ArrayExistSubseq.java  && cd classes && java ArrayExistSubseq && cd ..

import java.util.*; 

class ArrayExistSubseq 
{ 
