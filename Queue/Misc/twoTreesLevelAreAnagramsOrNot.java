...
// javac -d classes twoTreesLevelAreAnagramsOrNot.java  && cd classes && java twoTreesLevelAreAnagramsOrNot && cd ..
...
public class twoTreesLevelAreAnagramsOrNot 
{								 
	// A Binary Tree Node 
	static class Node 
	{ 
...
Given two binary trees, we have to check if each of their levels are anagrams of 
each other or not.
