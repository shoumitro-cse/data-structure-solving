...
//javac -d classes DistanceBet2node.java  && cd classes && java DistanceBet2node && cd .

public class DistanceBet2node {
	...
	public static int findDistance(Node root, int a, int b) {
		Node lca = LCA(root, a, b);//2

		int d1 = findLevel(lca, a, 0);//1
		int d2 = findLevel(lca, b, 0);//1
