// find maximum path sum between two leaves of a binary tree 

// javac -d classes MaxPathSumBetTwoLeaves.java  && cd classes && java MaxPathSumBetTwoLeaves && cd ..
...
class MaxPathSumBetTwoLeaves { 
	...
	int maxPathSumUtil(Node node, Res res) { 
		...
		// find maximum root to leaf sums in left and right subtrees and store them in ls and rs 
	...
	public static void main(String args[]) { 
		MaxPathSumBetTwoLeaves tree = new MaxPathSumBetTwoLeaves(); 
