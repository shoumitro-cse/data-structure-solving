...
//javac -d classes SumNumbersFormedRootToLeft.java  && cd classes && java SumNumbersFormedRootToLeft && cd ..
...
class SumNumbersFormedRootToLeft 
{ 
	Node root; 
	...
	{ 
		SumNumbersFormedRootToLeft tree = new SumNumbersFormedRootToLeft(); 
		...
		System.out.println("\n\nSum of all paths is " + tree.treePathsSum(tree.root)); 
	}	 
} 
...
// Time Complexity: The above code is a simple preorder traversal code which visits every exactly once. Therefore, 
// the time complexity is O(n) where n is the number of nodes in the given binary tree.