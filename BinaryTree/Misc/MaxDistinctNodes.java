...
//javac -d classes MaxDistinctNodes.java  && cd classes && java MaxDistinctNodes && cd ..

import java.util.*; 
class MaxDistinctNodes 
{ 
	...
	{ 
		...
		// if we reached a condition where all duplicate value of current node is deleted 
