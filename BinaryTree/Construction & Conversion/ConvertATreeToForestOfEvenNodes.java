// Convert a tree to forest of even nodes
 ...
 //javac -d classes ConvertATreeToForestOfEvenNodes.java  && cd classes && java ConvertATreeToForestOfEvenNodes && cd ..

import java.util.*; 

class ConvertATreeToForestOfEvenNodes {
	...
	// Return the maxium number of edge to remove to make forest. 
