...
// g++ ReverseDeleteAlgorithmMST.cpp && ./a.out
...
void Graph::reverseDeleteMST() {
	...
	cout << "Edges in MST\n"; 
	// Iterate through all sorted edges in decreasing order of weights 
	for (int i = edges.size()-1; i >= 0; i--) {
		...
		adj[u].remove(v); 
		adj[v].remove(u); 
		// Adding the edge back if removing it causes disconnection. In this case this 
