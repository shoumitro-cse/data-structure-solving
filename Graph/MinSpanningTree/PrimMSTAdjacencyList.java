...
// javac -d classes  PrimMSTAdjacencyList.java  && cd classes && java  PrimMSTAdjacencyList && cd ..

import java.util.LinkedList; 
import java.util.TreeSet; 
import java.util.Comparator; 

public class  PrimMSTAdjacencyList { 
	...
	// Comparator class created for PriorityQueue returns 1 if node0.key > node1.key 
	// returns 0 if node0.key < node1.key and returns -1 otherwise 
	...
	public static void main(String[] args) { 
		...
		PrimMSTAdjacencyList e = new PrimMSTAdjacencyList(); 
...
// pic (PrimMinSpanningTree.jpg & PrimMinSpanningTree1--6.jpg)