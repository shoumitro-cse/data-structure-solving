...
// g++ BoruvkaAlgorithmMST.cpp && ./a.out
...
// A utility function to find set of an element p (uses path compression technique) 
int find(struct subset subsets[], int p) { 
	// find root and make root as parent of p (path compression) 
