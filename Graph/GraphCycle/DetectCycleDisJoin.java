...
class DetectCycleDisJoin {
	...
	DetectCycleDisJoin(int v, int e) {
		V = v;
		E = e;
		edge = new Edge[E];
		for (int i = 0; i < e; ++i) {
	...
	public static void main (String[] args) {
		...
		int V = 3, E = 3;
		DetectCycleDisJoin graph = new DetectCycleDisJoin(V, E);
...
In this post, we will discuss the application of Disjoint Set Data Structure. The application is 
