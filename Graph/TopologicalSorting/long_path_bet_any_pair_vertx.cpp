...
// g++ long_path_bet_any_pair_vertx.cpp && ./a.out
...
int main() {
	...
	cout << "Maximum length of cable = "<< longestCable(graph, n)<<endl; 
...
We are given a map of cities connected with each other via cable lines such that there is 
no cycle between any two cities. We need to find the maximum length of cable between any two
cities for given city map.
