...
// javac -d classes  PathBet2TwoVertices.java  && cd classes && java PathBet2TwoVertices && cd ..
...
// representation
class PathBet2TwoVertices {

	private int V; // No. of vertices
	private LinkedList<Integer> adj[]; //Adjacency List

	//Constructor
	PathBet2TwoVertices(int v) {
	...
	public static void main(String args[]) {
		...
		PathBet2TwoVertices g = new PathBet2TwoVertices(4);
		g.addEdge(0, 1);
		g.addEdge(0, 2);
		g.addEdge(1, 2);
		g.addEdge(2, 0);
