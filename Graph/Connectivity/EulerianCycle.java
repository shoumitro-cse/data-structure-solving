...
// javac -d classes  EulerianCycle.java  && cd classes && java EulerianCycle && cd ..
...
A graph is said to be eulerian if it has a eulerian cycle. We have discussed eulerian circuit 
for an undirected graph. In this post, the same is discussed for a directed graph.
