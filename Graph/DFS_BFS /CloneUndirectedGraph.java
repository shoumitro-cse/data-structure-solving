...
// javac -d classes CloneUndirectedGraph.java  && cd classes && java CloneUndirectedGraph && cd ..
		...
		while (!q.isEmpty()) { 
			...
			if (u.neighbours != null) {
				...
				for (GraphNode graphNode : v) { 
					...
					// Get the corresponding cloned node If the node is not cloned then we will 
					// simply get a null 
