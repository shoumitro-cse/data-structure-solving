...
// javac -d classes  DijkstraShortestPath.java  && cd classes && java DijkstraShortestPath && cd ..
...
class DijkstraShortestPath { 
	...
	void dijkstra(int graph[][], int src) {
		...
		Boolean sptSet[] = new Boolean[V]; //SPT (shortest path tree) 
		...
		for (int count = 0; count < V - 1; count++) { // number of edge
