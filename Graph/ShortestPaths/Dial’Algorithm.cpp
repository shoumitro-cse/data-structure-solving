...
// Prints shortest paths from src to all other vertices. W is the maximum weight of an edge 
...
representation (See C implementation and STL based C++ implementations for details).
