// Java program to find longest contiguous subsequence 

//javac -d classes LongestContiguousSubsequ.java  && cd classes && java LongestContiguousSubsequ && cd ..

import java.io.*; 
import java.util.*; 

class LongestContiguousSubsequ { 
