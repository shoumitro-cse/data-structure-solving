// Java Program to prints common element in all rows of matrix 

//javac -d classes CommonEleRowsOfMatrix.java  && cd classes && java CommonEleRowsOfMatrix && cd ..

import java.util.*; 

class CommonEleRowsOfMatrix { 
