...
//javac -d classes LoadFactorAndRehashing.java  && cd classes && java LoadFactorAndRehashing && cd ..
...
class Map<K, V> { 
	...
	public void insert(K key, V value) { 
		...
		// the new node is inserted by making it the head 
		...
		// Incrementing size as new K-V pair is added to the map 
		size++; 
